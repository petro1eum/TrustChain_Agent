                    ...
                    <>
                        ...
                        {filteredSessions.length === 0 && (
                            <div className="px-3 py-6 text-center">
                                <MessageSquare size={24} className="mx-auto tc-text-muted mb-2 opacity-40" />
                                <div className="text-[12px] tc-text-muted">No conversations yet</div>
                                <div className="text-[11px] tc-text-muted mt-0.5">Click "New Chat" to start</div>
                            </div>
                        )}
