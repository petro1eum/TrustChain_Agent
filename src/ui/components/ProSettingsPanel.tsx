...
import { Shield, Crown, Building2, FileText, ToggleLeft, ToggleRight, AlertTriangle, Key, Users, Calendar } from 'lucide-react';
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    {COMPLIANCE_FRAMEWORKS.map(fw => {
                        ...
                        return (
                            <button
                                key={fw.id}
                                onClick={() => available && toggleCompliance(fw.id)}
                                style={{
